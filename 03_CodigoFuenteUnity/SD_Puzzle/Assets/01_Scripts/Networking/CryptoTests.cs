...
{	
		string plaintext = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.";

		string password1 = "$tr0ngP4ssw0rd!";
		string password2 = "U|n8r34k@bl3?";

		string exampleValidIV = "c+MasEKX86kbnwFowjVAyA==";

        public AESEncryptedText encryptionResult;

        void Start(){
            encryptionResult = Encrypt(plaintext,password1);
            print(encryptionResult.IV);
            print(encryptionResult.EncryptedText);
            
            string txt = Decrypt(encryptionResult,password1);
            print(txt);
        }
